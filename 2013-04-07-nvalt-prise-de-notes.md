---
title: "La prise de notes avec nvALT"
date: "2013-04-07"
categories: 
  - "apps"
  - "dossier"
...
[nvALT](http://brettterpstra.com/projects/nvalt/) est une application _gratuite_, légère et rapide qui permet de **prendre des notes instantanément**.
...
[Fork](http://fr.wikipedia.org/wiki/Fork) du déjà très bon [Notational Velocity](http://notational.net/fr/), **nvALT** possède de nombreux avantages :
...
Une BDD pour ses notes peut être utile dans certains cas : si vous avez d'énormes quantités de données à traiter, données ayant les mêmes champs et tags, alors manipuler plusieurs milliers de fichiers n'est _peut-être_ pas le bon choix. A vous de voir.
...
> nvALT propose en option de fonctionner avec une base de données au lieu de fichiers texte. Même si l'application reste agréable à utiliser dans ce cas, ça reste une gestion "à l'ancienne" avec un format que l'on ne peut pas utiliser en dehors de l'application qui le produit.
...
Surtout : les fichiers texte en Markdown, c'est _universel_ et paré pour le futur (contrairement à mes vieux fichiers des années 80, sniff).

![](https://aya.io/blog/images/nvalt-prise-de-notes-1.png)
...
![Fichiers, Dropbox, extensions](https://aya.io/blog/images/Notes.png)
...
![Options d'édition](https://aya.io/blog/images/Editer.png)

- Choisissez une présentation horizontale ou verticale
- Choisissez vos thèmes et couleurs

![Polices et couleurs](https://aya.io/blog/images/Couleurs.png)
...
_Une fois l'application active on commence tout de suite à écrire dans la zone de titre._

> click sur son icone dans le dock ou dans la menubar, activé par ALT/TAB, par son raccourci clavier, etc

![Nouvelle note](https://aya.io/blog/images/nvalt-1.png)
...
![Liste des notes](https://aya.io/blog/images/nvalt-2.png)
...
![Prévisualisation nvALT](https://aya.io/blog/images/capture3358.png)
...
Intégrez le CSS de votre blog ou ebook à nvALT pour avoir un aperçu de ce que donnera votre document.

> Vous pouvez également télécharger des thèmes prédéfinis : [Byword](http://bywordapp.com/extras/index.html), [iAwriter](https://github.com/moritzz/iAWriterCSS), [play with Marked](http://www.candlerblog.com/2012/02/29/marked-as-css-playground/)
...
![Hazel : déplace vers archive](https://aya.io/blog/images/capture0422.png)
...
Elle passe alors de _note_ à _brouillon_ dans mon esprit : aussitôt je la tagge avec `SHIFT+CMD+T` avec le mot-clé de mon choix, ici `post` ou `brouillon` par exemple.
...
![Hazel : déplace vers autre éditeur](https://aya.io/blog/images/capture5339.png)

## Mode auteur

On peut configurer nvALT pour le mettre dans un état que j'appelle le mode _auteur_, c'est-à-dire sans distractions et concentré sur le texte.
...
![Mou](https://aya.io/blog/images/nvalt-prise-de-notes-2.png)
...
_**Update** - Drafts pour iOS est une formidable application mais n'est pas si bien adaptée que ça à notre workflow avec nvALT et Dropbox. Il vaut mieux utiliser un bon éditeur [iOS](http://aya.io/blog/editeurs-de-texte-osx-ios/)._

![](https://aya.io/blog/images/elements-small.jpg)
...
- Des automatismes avec [ifttt](http://www.ifttt.com) ou [zapier](https://zapier.com/) permettent d'uploader automatiquement ses notes à partir de Dropbox vers un autre service.
